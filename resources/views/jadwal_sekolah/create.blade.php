@extends('layout.main')
@section('title','Tambah Jadwal Sekolah')
    ...
    <div class="col-12">
        <div class="card card-primary card-outline mb-4">
            ...
            <div class="card-header">
                <div class="card-title"><b>Tambah Jadwal Sekolah</b></div>
            </div>
            <!--end::Header-->

            <!--begin::Form-->
            <form action="{{ route('jadwal_sekolah.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!--begin::Body-->
                <div class="card-body">
                    <div class="mb-3">
                        <label for="hari_sekolah" class="form-label">Hari Sekolah</label>
                        <input type="text" class="form-control" name="hari_sekolah" value="{{ old('hari_sekolah') }}">
                        @error('hari_sekolah')
