    ...
    <div class="col-12">
        ...
        <div class="card card-primary card-outline mb-4">
            ...
            <div class="card-header">
                <h3 class="card-title"><b>Edit Kehadiran</b></h3>
            </div>
            <!--end::Header-->
            ...
            <form action="{{ route('kehadiran.update', $kehadiran->id) }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="departemen" maxlength="50" value="{{ old('departemen') ?? $kehadiran->departemen }}">
                        @error('departemen')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" class="form-control" name="jam_hadir" value="{{ old('jam_hadir') ?? $kehadiran->jam_hadir }}">
                        @error('jam_hadir')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
