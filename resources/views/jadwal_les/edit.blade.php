            ...
            <form action="{{ route('jadwal_les.update', $jadwal_les->id) }}" method="POST">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="hari_les" value="{{ old('hari_les') ? old('hari_les') : $jadwal_les->hari_les }}">
                        @error('hari_les')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" class="form-control" name="jam_mulai" value="{{ old('jam_mulai') ? old('jam_mulai') : $jadwal_les->jam_mulai }}">
                        @error('jam_mulai')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" class="form-control" name="jam_selesai" value="{{ old('jam_selesai') ? old('jam_selesai') : $jadwal_les->jam_selesai }}">
                        @error('jam_selesai')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="mata_pelajaran" value="{{ old('mata_pelajaran') ? old('mata_pelajaran') : $jadwal_les->mata_pelajaran }}">
